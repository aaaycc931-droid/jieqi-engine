...
function startGame(): void {
  ...
  const redHero = element<HTMLSelectElement>("red-hero").value as HeroId | "";
  const blackHero = element<HTMLSelectElement>("black-hero").value as HeroId | "";
  const mutation = element<HTMLSelectElement>("mutation").value as MutationId | "";
  localHeroes = {
    ...(redHero ? { red: redHero } : {}),
